...
hi Visual  guifg=NONE guibg=#845843 gui=NONE
hi CursorLine  guifg=NONE guibg=#00223f gui=NONE
hi CursorColumn  guifg=NONE guibg=#00223f gui=NONE
hi LineNr  guifg=#8099b0 guibg=#003360 gui=NONE
hi VertSplit  guifg=#305a7e guibg=#305a7e gui=NONE
hi MatchParen  guifg=#ff9d00 guibg=NONE gui=NONE
hi StatusLine  guifg=#ffffff guibg=#305a7e gui=bold
hi StatusLineNC  guifg=#ffffff guibg=#305a7e gui=NONE
hi Pmenu  guifg=#ffdd00 guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#845843 gui=NONE
hi IncSearch  guifg=NONE guibg=#436584 gui=NONE
hi Search  guifg=NONE guibg=#436584 gui=NONE
hi Directory  guifg=#ff628c guibg=NONE gui=NONE
hi Folded  guifg=#0088ff guibg=#003360 gui=NONE

hi Normal  guifg=#ffffff guibg=#003360 gui=NONE
...
hi NonText  guifg=#367cbe guibg=#00223f gui=NONE
...
hi SpecialKey  guifg=#367cbe guibg=#00223f gui=NONE
